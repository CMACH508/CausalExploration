...
def pc(
    ...
    **kwargs
    ...
    if mvpc:  # missing value PC
        ...
        return pc_alg(data=data, node_names=node_names, alpha=alpha, indep_test=indep_test, state_dim=state_dim,stable=stable, uc_rule=uc_rule,
...
def pc_alg(
    ...
    **kwargs
    ...
    cg_1, time_list = skeleton_discovery(data, alpha, indep_test, state_dim, stable,
